...
public class LogTrackAspect  {
    ...
    @Pointcut(value = "@annotation(com.ligan.framework.Aop.WordLog)")
    public void access() {
    }
    ...
    //环绕增强，是在before前就会触发
    @Around("@annotation(wordLogTrack)")
    public Object around(ProceedingJoinPoint pjp, WordLog wordLogTrack) throws Throwable {
...
//        System.out.println("获取参数："+map.get("username")[0])
        ...
        String logTrackValue = wordLogTrack.value();
